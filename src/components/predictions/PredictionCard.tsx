...
import type { Prediction, PredictionOption, PredictionCardProps } from '@/types/types';
...
export const PredictionCard = ({ prediction }: PredictionCardProps) => {
    ...
    const { placeBet, addToWatchlist, removeFromWatchlist, watchlist } = usePredictionStore();
