            ...
            >
                <div className="p-4 sm:p-6">
                    ...
                    <div className="flex items-start justify-between mb-4 sm:mb-6">
                        <div className="flex items-start space-x-2 sm:space-x-3 flex-1 min-w-0">
                            ...
                            <div className="flex-1 min-w-0">
                                <h2 className="text-base sm:text-xl font-bold text-card-foreground leading-tight">{title}</h2>
                                <p className="text-xs sm:text-sm text-muted-foreground mt-0.5">Secure & Decentralized</p>
                            </div>
                        </div>
                        <button
                            onClick={handleClose}
                    ...
                    <div className="mb-4 sm:mb-6">
                        <p className="text-sm sm:text-base text-card-foreground leading-relaxed">{message}</p>
                    </div>

                    {/* Benefits */}
                    <div className="mb-6 sm:mb-8">
                        <h3 className="text-xs sm:text-sm font-semibold text-card-foreground mb-2.5 sm:mb-3">Why connect your wallet?</h3>
                        <div className="space-y-2.5 sm:space-y-3">
                            <div className="flex items-center space-x-2.5 sm:space-x-3">
                                <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 dark:bg-green-900/20 rounded-full flex items-center justify-center flex-shrink-0">
                                ...
                                <span className="text-xs sm:text-sm text-card-foreground">Place bets on predictions</span>
                            </div>
                            <div className="flex items-center space-x-2.5 sm:space-x-3">
                                <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 dark:bg-green-900/20 rounded-full flex items-center justify-center flex-shrink-0">
                                    <svg className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-green-600 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <span className="text-xs sm:text-sm text-card-foreground">Track your positions</span>
                            </div>
                            <div className="flex items-center space-x-2.5 sm:space-x-3">
                                <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 dark:bg-green-900/20 rounded-full flex items-center justify-center flex-shrink-0">
                                    <svg className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-green-600 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <span className="text-xs sm:text-sm text-card-foreground">Earn rewards & profits</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-4 sm:mt-6 p-2.5 sm:p-3 bg-muted/50 rounded-lg">
                        <div className="flex items-start space-x-2">
                            <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-blue-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            <div>
                                <p className="text-[10px] sm:text-xs text-muted-foreground leading-relaxed">
                                    <strong>Secure:</strong> Your wallet connection is encrypted and never stored on our servers.
