...
export const generateDemoPredictions = (): Prediction[] => {
  ...
  // Token predictions (15) - Mix of cardTypes
  const tokenPredictions = [
    {
      title: "Bitcoin will reach $100,000 by end of 2024",
      description:
        "Will Bitcoin's price hit $100,000 before December 31, 2024?",
      tags: ["bitcoin", "crypto", "price", "bullrun"],
      cardType: "simple" as const,
    },
    {
      title: "Which quarter will Ethereum implement EIP-4844?",
      description:
        "When will Ethereum successfully implement EIP-4844 (proto-danksharding)?",
      tags: ["ethereum", "upgrade", "scaling", "danksharding"],
      cardType: "date-based" as const,
    },
    {
      title: "What will be Solana's peak TPS in 2024?",
      description:
        "What range will Solana's peak transactions per second fall into in 2024?",
      tags: ["solana", "tps", "performance", "blockchain"],
      cardType: "range-based" as const,
    },
    {
      title: "When will the next major crypto bull run begin?",
      description:
        "When will the next major cryptocurrency bull run officially begin?",
      tags: ["crypto", "bullrun", "market", "timing"],
      cardType: "multiple-options" as const,
    },
    {
      title: "Chainlink will launch 100+ price feeds by Q3 2024",
      description:
        "Will Chainlink add 100 or more new price feeds by September 30, 2024?",
  ...
  const politicsPredictions = [
    ...
    },
    {
      ...
      description:
        "Will any robbers from the Louvre heist be arrested by the specified dates?",
    ...
    },
    {
      ...
      description:
        "If Joe Biden is re-elected in 2024, will he serve his full second term?",
    ...
    },
    {
      ...
      description:
        "Will the European Union have 30 or more member states by December 31, 2024?",
    ...
    },
    {
      ...
      description:
        "Will Russia withdraw all military forces from Ukraine by June 30, 2024?",
      tags: ["russia", "ukraine", "war", "withdrawal"],
    },
    {
      title: "India will become world's 3rd largest economy in 2024",
      description:
        "Will India overtake Japan to become the world's 3rd largest economy in 2024?",
      tags: ["india", "economy", "gdp", "ranking"],
    },
    {
      title: "Brazil will re-elect Lula in 2024",
      description:
        "Will Luiz Inácio Lula da Silva be re-elected as President of Brazil in 2024?",
    ...
    },
    {
      ...
      description:
        "Will South Korea and North Korea begin reunification process by 2030?",
      tags: ["korea", "reunification", "north-korea", "south-korea"],
    },
    {
      title: "Israel will establish peace with Palestine in 2024",
      description:
        "Will Israel and Palestine reach a comprehensive peace agreement in 2024?",
    ...
    },
    {
      ...
      description:
        "Will Saudi Arabia establish full diplomatic relations with Israel in 2024?",
  ...
  const entertainmentPredictions = [
    {
      ...
      description:
        "How many tweets will Elon Musk post between October 14-21, 2025?",
    ...
    },
    {
      ...
      description:
        "Will Netflix reach 300 million or more subscribers by December 31, 2024?",
      tags: ["netflix", "subscribers", "streaming", "growth"],
    },
    {
      title: "Disney+ will overtake Netflix in subscribers by Q4 2024",
      description:
        "Will Disney+ have more subscribers than Netflix by Q4 2024?",
    ...
    },
    {
      ...
      description:
        "Will Avatar 3 be the highest grossing movie worldwide in 2024?",
      tags: ["avatar", "movies", "box-office", "james-cameron"],
    },
    {
      title: "Spotify will reach 600M users by end of 2024",
      description:
        "Will Spotify reach 600 million or more monthly active users by December 31, 2024?",
      tags: ["spotify", "music", "users", "growth"],
    },
    {
      title: "TikTok will be banned in the US in 2024",
      description:
        "Will TikTok be officially banned in the United States in 2024?",
    ...
    },
    {
      ...
      description:
        "Will Tesla begin deliveries of the Cybertruck to customers in 2024?",
  ...
  const sportsPredictions = [
    {
      ...
      description:
        "Will the Los Angeles Lakers win the NBA Championship in 2024?",
    ...
    },
    {
      ...
      description:
        "Will Novak Djokovic win the Wimbledon men's singles title in 2024?",
      tags: ["djokovic", "wimbledon", "tennis", "grand-slam"],
    },
    {
      title: "Hamilton will win F1 Championship in 2024",
      description:
        "Will Lewis Hamilton win the Formula 1 World Championship in 2024?",
      tags: ["hamilton", "f1", "formula-1", "championship"],
    },
    {
      title: "Warriors will make NBA playoffs in 2024",
      description:
        "Will the Golden State Warriors qualify for the NBA playoffs in 2024?",
    ...
    },
    {
      ...
      description:
        "Will the 2024 Summer Olympics be held in Paris as scheduled?",
  ...
  const allPredictions = [
    ...
    ...entertainmentPredictions.map((p, i) => ({
      ...p,
  ...
  allPredictions.forEach((prediction, index) => {
    ...
    let cardType: "simple" | "multiple-options" | "date-based" | "range-based" =
      "simple";
    ...
    if (
      prediction.title.includes("Mayoral Election") ||
      prediction.title.includes("Championship")
    ) {
      ...
      prediction.title.includes("heist") ||
      prediction.title.includes("by...")
    ) {
      cardType = "date-based";
      ...
      prediction.title.includes("tweets") ||
      prediction.title.includes("range")
    ) {
...
export const fetchPredictionById = async (
  id: string,
